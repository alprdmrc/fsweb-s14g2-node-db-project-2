  ...
  describe("[POST] /api/cars", () => {
    ...
    test("[12] responds with a 400 and proper error on non-unique vin", async () => {
      ...
      expect(res.body).toHaveProperty(
        "message",
        "vin 11111111111111111 zaten var"
      );
    }, 750);
  });
});
